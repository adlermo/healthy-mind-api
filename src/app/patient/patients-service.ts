...
class PatientsService {
   ...
   * @param therapist {@link Patient} professional data to update
   ...
   * @param res {@link Response} response to return to user
   * @returns {@link Promise<boolean>} returns a promise that resolves to
   * therapist {@link Patient} in success or null in error
   */
  async getTherapistById(id: string, res: Response): Promise<Patient | null> {
  ...
  /**
   *
   * @param therapist {@link Patient} professional data to create
   * @param res {@link Response} response to return to user
   * @returns {@link Promise<boolean>} returns a promise that resolves true for success or false in error
   */
  async createTherapist(therapist: Patient, res: Response): Promise<boolean> {
